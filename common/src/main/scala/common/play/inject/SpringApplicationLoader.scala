...
//
//    Logger.debug("createApplicationContext... ")
...
//      case nonRoot =>
//        //modified by liubin
//        val bdh = new BeanDefinitionHolder(new RootBeanDefinition(new RootBeanDefinition(nonRoot.getBeanClassName)), bdHolder.getBeanName)
