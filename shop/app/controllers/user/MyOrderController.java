...
public class MyOrderController extends Controller {
     ...
     */
    @SecuredAction
    public Result orderContent(int orderId, int queryType, int pageNo) {
        User user = SessionUtils.currentUser();
        ...
        return ok(myOrderInfo.render(order, logistics, orderStateHistories, trade, queryType, pageNo));
     ...
     */
    @SecuredAction
    public Result backContent(int backGoodsId, int pageNo) {
        User user = SessionUtils.currentUser();
        ...
        return ok(myBackInfo.render(backGoods,backGoodsLogs,pageNo));
