...
// 网站公用弹出框对话框
FG.Dialog = function (options) {
    this.options = options || {};
    this.retuenVal = false;
    this.defaultOptions = {
        buttons: [],
        type: FG.Dialog.type.INFO,
...
FG.Dialog.prototype = {
    ...
    generateHTML: function () {
        ...
        if (this.defaultOptions.isConfirm) {
            ...
            if(this.defaultOptions.buttons == null){

            }else if (this.defaultOptions.buttons.length < 1) {
...
// 确认对话框
FG.dialogConfirm = function (e, info, callback) {
    new FG.Dialog({
        type: FG.Dialog.type.WARN,
        title: '提示',
        isModal: true,
...
FG.dialogAlertXl = function (msg, type, buttons) {
    ...
    new FG.Dialog({
        ...
        border: '1px solid #ddd;',
        backgroundColor: '#ffffff',
        type: type || FG.Dialog.type.ERROR,
        info: msg || '服务器发生错误',
        infoStyle: {
            height: '100px'
        },
