...
(function ($) {
    "use strict";
    FG.user.FormValidate = function (options, callback) {
    ...
    FG.user.FormValidate.prototype.init = function () {
        var root = this;
        root.eachValidate(true); // 绑定事件
        root.submit();
    };

    FG.user.FormValidate.prototype.isPlaceholder = ('placeholder' in document.createElement('input'));

    // 验证数据无误后提交
    FG.user.FormValidate.prototype.submit = function () {
        var root = this,
            isValidate = true;
    ...
    FG.user.FormValidate.prototype.isValidate = function () {
    ...
    // 遍历绑定事件或直接验证
    FG.user.FormValidate.prototype.eachValidate = function (isBind) {
        var root = this,
            items = this.items,
            i,
            itemEle,
    ...
    // 验证是否合法
    FG.user.FormValidate.prototype.validate = function (ele, item) {
    ...
    // 给元素绑定事件
    FG.user.FormValidate.prototype.bind = function (item) {
        var root = this,
            ele = $('#' + item.id);
    ...
    // 输入提示
    FG.user.FormValidate.prototype.tips = function (ele, item) {
    ...
    // 移除输入提示
    FG.user.FormValidate.prototype.removeTips = function (item) {
